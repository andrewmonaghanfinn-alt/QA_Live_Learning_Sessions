...
{
    private static final String FILE_NAME = "src/main/java/Labs/lab15/shared_file.txt";
...
class WorkerThread implements Runnable
{
    ...
    public void run()
    {
        ...
        try {
            ...
            for (int i = 0; i < 1000; i++) {
                unsafeWriteToFile(message + " #" + i, writer);
            }
            writer.close();
        } catch (IOException e) {
    ...
    private void unsafeWriteToFile(String message, BufferedWriter writer) {
        try {
